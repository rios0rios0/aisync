...
const (
	...
	// rune — so "ContosoSecurity" catches "contoso-security", "Contoso Security",
	// "CONTOSO_SECURITY", "contosó-sécurity", and every other normal writing
...
// matching: "Contosó Security" and "contoso-security" both canonicalize to
// "contososecurity". Exported so tests and the scanner pipeline can share a
